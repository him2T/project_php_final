                            ...
                            <nav class="axil-dashboard-nav">
                                <div class="nav nav-tabs" role="tablist">
                                    ...
                                    <a class="nav-item nav-link" data-bs-toggle="tab" href="#nav-change-password"
                                        role="tab" aria-selected="false"><i class="fas fa-lock"></i>Đổi mật khẩu</a>
                            ...
                            <div class="tab-pane fade" id="nav-change-password" role="tabpanel">
                                <div class="col-lg-9">
                                    <div class="axil-dashboard-order">
                                        <form class="account-details-form" id="password-change-form">
                                            <div class="form-group">
                                                <label for="current-password">Mật khẩu hiện tại:</label>
                                                <input type="password" class="form-control" style="background-color: white;" placeholder="Nhập mật khẩu hiện tại" id="current-password" name="current_password">
                                            </div>
                                            <div class="form-group">
                                                <label for="new-password">Mật khẩu mới:</label>
                                                <input type="password" class="form-control" style="background-color: white;" placeholder="Nhập mật khẩu mới" id="new-password" name="new_password">
                                            </div>
                                            <div class="form-group">
                                                <label for="confirm-password">Điền lại mật khẩu mới:</label>
                                                <input type="password" class="form-control" style="background-color: white;" placeholder="Nhập lại mật khẩu mới" id="confirm-password" name="confirm_password">
                                            </div>
